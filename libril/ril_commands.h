...
*/
    ...
    {RIL_REQUEST_REGISTRATION_STATE, dispatchVoid, responseVoid},
    {RIL_REQUEST_GPRS_REGISTRATION_STATE, dispatchVoid, responseVoid},
    ...
    {RIL_REQUEST_SET_CELL_BROADCAST_CONFIG, dispatchVoid, responseVoid}, // 10001
