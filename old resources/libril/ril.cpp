...
#define MAX_RIL_SOL     RIL_REQUEST_GET_BARCODE_NUMBER
#define MAX_RIL_UNSOL   RIL_UNSOL_RESPONSE_NETWORK_STATE_CHANGED
...
processCommandBuffer(void *buffer, size_t buflen) {
    ...
    if (request < 1 || ((request > MAX_RIL_SOL) &&
            ...
            request > RIL_REQUEST_GET_BARCODE_NUMBER) {
...
processRadioState(RIL_RadioState newRadioState) {
    ...
    if((newRadioState > RADIO_STATE_UNAVAILABLE) && (newRadioState < RADIO_STATE_ON)) {
        ...
        if(newSimStatus != simRuimStatus) {
            ...
            RIL_UNSOL_RESPONSE(RIL_UNSOL_RESPONSE_SIM_STATUS_CHANGED, NULL, 0);
        }
...
*/
    switch(request) {
        ...
        case RIL_REQUEST_REGISTRATION_STATE: return "RIL_REQUEST_REGISTRATION_STATE";
        case RIL_REQUEST_GPRS_REGISTRATION_STATE: return "RIL_REQUEST_GPRS_REGISTRATION_STATE";
